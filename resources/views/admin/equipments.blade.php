          ...
          <div class="tm-bg-primary-dark tm-block tm-block-products">
            <div class="tm-product-table-container">
              <table class="table table-hover tm-table-small tm-product-table">
                ...
                <tr>
                    <th scope="row"></th>
                    <td class="tm-product-name">{{ $value->equipmentname }}</td>
                    <td>{{ $value->price }}</td>
                    <td>{{ $value->stock }}</td>
                    <td>
                      <a href= "/equipments/{{$value->id}}" class="tm-product-delete-link">
            ...
            <a
              href="/add-equipment"
              class="btn btn-primary btn-block text-uppercase mb-3">Add new Equipment</a>

              <a
              href="/update-equipment"
              class="btn btn-primary btn-block text-uppercase mb-3">Update Equipment</a>
          </div>
