      ...
      <div class="row tm-content-row">
        <div class="col-sm-12 col-md-12 col-lg-8 col-xl-12 tm-block-col">
          <div class="tm-bg-primary-dark tm-block tm-block-products">
              ...
              <table class="table table-hover tm-table-small tm-product-table">
                <thead>
                  <tr>
                    ...
                    <th scope="col">CONSULTANCYCHARGE</th>
                ...
                <tr>
                    <th scope="row"></th>
                    <td class="tm-product-name">{{ $value->doctorname }}</td>
                    <td>{{ $value->specification }}</td>
                    <td>{{ $value->consultancycharge }}</td>
                    <td>{{ $value->avaibility }}</td>
                    <td>
                      <a href= "/doctors/{{$value->id}}"   class="tm-product-delete-link">
            ...
            <a
              href="/doctor"
              class="btn btn-primary btn-block text-uppercase mb-3">Add new Doctor</a>
            
            <a
              href="/update-doctor"
              class="btn btn-primary btn-block text-uppercase mb-3">Update Doctor</a>
          </div>
        </div>
    </div>
    </form>
