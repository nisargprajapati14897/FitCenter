	...
	<div class="container">
		<div class="row">
			<div class="col-md-8">
				...
				<a href="/upricing" class="btn btn-main " >Join Us <i class="ti-angle-right ml-3"></i></a>
			</div>
		</div>
	</div>
</section>
		...
		<div class="row ">
			<div class="col-lg-4 col-md-6">
				<div class="card p-5 border-0 rounded-top border-bottom position-relative hover-style-1">
					...
					<p class="mt-3 mb-4">By modern equipment it is eassy to help us workout and gain more strength.</p>
					<a href="/uabout" class="text-color text-uppercase font-size-13 letter-spacing font-weight-bold"><i class="ti-minus mr-2 "></i>more Details</a>
				</div>
			</div>
			<div class="col-lg-4 col-md-6">
				<div class="card p-5 border-0 rounded-top hover-style-1">
					...
					<p class="mt-3 mb-4">We can get Professional Trainers for beginners and to get help for hard workout.</p>
					<a href="/uabout" class="text-color text-uppercase font-size-13 letter-spacing font-weight-bold"><i class="ti-minus mr-2 "></i>more Details</a>
				</div>
			</div>
			<div class="col-lg-4 col-md-6">
				<div class="card p-5 border-0 rounded-top hover-style-1">
					...
					<p class="mt-3 mb-4">We can provide diet plan to maintain body structure for members by their diet chart.</p>
					<a href="/uabout" class="text-color text-uppercase font-size-13 letter-spacing font-weight-bold"><i class="ti-minus mr-2 "></i>more Details</a>
				</div>
			</div>
		</div>
...
<section class="section about">
	<div class="container">
		<div class="row align-items-center">
			<div class="col-lg-6">
				<img src="user/images/hipcravo-eFx1KZhaSvo-unsplash.jpg" alt="" class="img-fluid rounded shadow w-100">
			</div>
		...
		<div class="row justify-content-center">
			<div class="col-lg-8 col-md-12 col-sm-12">
				<div class="text-center">
					...
					<a href="/upricing" class="btn btn-main text-white">Join Today</a>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="row no-gutters">
			<div class="col-lg-4 col-md-6 col-sm-6">
				<div class="text-center  px-4 py-5 hover-style-1">
					...
					<p>we provide best weight lifting equipment in our gym.</p>
				</div>
			</div>
			<div class="col-lg-4 col-md-6 col-sm-6">
				<div class="text-center  px-4 py-5 hover-style-1">
					...
					<p>Before exercise 5 minitues cycling is best for workout.</p>
				</div>
			</div>
			<div class="col-lg-4 col-md-6 col-sm-6">
				<div class="text-center  px-4 py-5 hover-style-1">
					...
					<p>Yoga and Meditation is best for mind and body health.</p>
				</div>
			</div>
			<div class="col-lg-4 col-md-6 col-sm-6">
				<div class="text-center  px-4 py-5 hover-style-1">
					...
					<p>We provide many body building equipment to gain weight and mussels.</p>
				</div>
			</div>
			<div class="col-lg-4 col-md-6 col-sm-6">
				<div class="text-center  px-4 py-5 hover-style-1">
					...
					<p>we provide running track for runners and it is best for warmup.</p>
				</div>
			</div>
			<div class="col-lg-4 col-md-6 col-sm-6">
				<div class="text-center  px-4 py-5 hover-style-1">
					...
					<p>you can maintain fitness by doing daily exercise and diet chart.</p>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="container-fluid p-0">
		<div class="row no-gutters portfolio-gallery">
			<div class="col-lg-3 col-md-6 col-sm-6">
				<a href="user/images/gallery/gallery-01.jpg" class="popup-gallery">
					<img src="user/images/gallery/gallery-01.jpg" alt="" class="img-fluid">
				</a>
			</div>
			<div class="col-lg-3 col-md-6 col-sm-6">
				<a href="user/images/gallery/gallery-02.jpg" class="popup-gallery">
					<img src="user/images/gallery/gallery-02.jpg" alt="" class="img-fluid">
				</a>
			</div>
			<div class="col-lg-3 col-md-6 col-sm-6">
				<a href="user/images/gallery/gallery-03.jpg" class="popup-gallery">
					<img src="user/images/gallery/gallery-03.jpg" alt="" class="img-fluid">
				</a>
			</div>
			<div class="col-lg-3 col-md-6 col-sm-6">
				<a href="user/images/gallery/gallery-04.jpg" class="popup-gallery">
					<img src="user/images/gallery/gallery-04.jpg" alt="" class="img-fluid">
				</a>
			</div>
			<div class="col-lg-3 col-md-6 col-sm-6">
				<a href="user/images/gallery/gallery-05.jpg" class="popup-gallery">
					<img src="user/images/gallery/gallery-05.jpg" alt="" class="img-fluid">
				</a>
			</div>
			<div class="col-lg-3 col-md-6 col-sm-6">
				<a href="user/images/gallery/gallery-06.jpg" class="popup-gallery">
					<img src="user/images/gallery/gallery-06.jpg" alt="" class="img-fluid">
				</a>
			</div>
			<div class="col-lg-3 col-md-6 col-sm-6">
				<a href="user/images/gallery/gallery-07.jpg" class="popup-gallery">
					<img src="user/images/gallery/gallery-07.jpg" alt="" class="img-fluid">
				</a>
			</div>
			<div class="col-lg-3 col-md-6 col-sm-6">
				<a href="user/images/gallery/gallery-08.jpg" class="popup-gallery">
					<img src="user/images/gallery/gallery-08.jpg" alt="" class="img-fluid">
				</a>
			</div>
		</div>
	</div>
...
<section class="section textimonial position-relative bg-2">
	<div class="container">
		<div class="row justify-content-center">
			<div class="col-lg-8">
				<div class="row justify-content-center">
				...
				<div class="testimonial-slider">
					<div class="text-center mb-4 ">
						<i class=" text-lg text-color"></i>
						<h3 class="mt-4 text-white letter-spacing">A great Start to a healthy life</h3>
						<p class="my-4 text-white-50">Your weight loss diet should not be at the cost of your health. Instead, opt for the weight loss training program where you lose weight gradually while staying fit.</p>

						<div>
							<h4 class="mb-0 text-capitalize text-white font-weight-normal">Nisarg Prajapati</h4>
					...
					<div class="text-center mb-4">
						...
						<p class="my-4 text-white-50">Strength training also means that you will be able to retain your muscle mass during your training, which means your body will newer for longer periods without much of an effort.</p>
						<div>
							<h4 class="mb-0 text-capitalize text-white font-weight-normal">Jaydeep Trivedi</h4>
					...
					<div class="text-center mb-4">
						...
						<p class="my-4 text-white-50">A personal training plan that includes diet, exercise, weight training, aerobics, yoga, and cardio to the trick. personal gym trainer will help you to weight loss training complete with the diet chart.</p>
						<div>
							<h4 class="mb-0 text-capitalize text-white font-weight-normal" >Jaydeep Parmar</h4>
							<span class="text-white-50">Assistant-Manager</span>
						</div>
					</div>
					...
					<div class="text-center mb-4">
						...
						<p class="my-4 text-white-50">The best training program is definitely that of trial and error. Yes! Each body type is different its needs a persional traner. In the same way the training program varies from individual to individual.</p>
						<div>
							<h4 class="mb-0 text-capitalize text-white font-weight-normal">God Father</h4>
							<span class="text-white-50">Executive</span>
						</div>
					</div>
				</div>
			</div>
