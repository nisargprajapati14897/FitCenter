    ...
    <div class="container">
         ...
         <div class="row justify-content-center pb-5">
            ...
            @foreach($data as $value)
                   ...
                   <form method="post" action="{{url('equicheckoutform',['id'=>$value->id])}}" enctype="multipart/form-data" class="tm-edit-product-form">
                    {{ csrf_field() }}

                    <h4 class="mb-3 font-secondary">{{ $value->equipmentname }}</h4>
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="form-group">
                                <input name="area" type="text" class="form-control" placeholder="Enter your Area" required> 
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="form-group">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            ...
                            <div class="text-center">
                                <button class="btn btn-main mt-3 " type="submit">Place Order</button>
                            </div>
