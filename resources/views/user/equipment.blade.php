...
<section class="section blog bg-gray">
	...
	<article class="card border-0 rounded-0 mb-4">
		...
		<div class="mt-3 px-4 py-3 ">
			...
			<div class="blog-post-meta text-capitalize mb-4">
				<span class="post-meta date-meta mr-2">
				<i class=" mr-2"></i>{{ $value->stock }}</span> 
				<span class="post-meta author">Stock Availlable</span>
			</div>
			

				<a href="/equicheckoutform/{{ $value->id }}"  class="btn btn-main">Buy now</a>
		</div>
	</article>
</div>
@endforeach
