  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-12 text-center">
           ...
           <h5 class="text-lg text-white mt-2">Enter your details below</h5>
      </div>
    </div>
  </div>
</section>
    ...
    <div class="container">
         ...
         <div class="row justify-content-center pb-5">
            ...
            @foreach($data as $value)
                <form method="post" action="{{url('doccheckoutform',['id'=>$value->id])}}" enctype="multipart/form-data" class="tm-edit-product-form">
                    {{ csrf_field() }}

                    <h4 class="mb-3 font-secondary">{{ $value->doctorname }}</h4>
                    <p class="mb-3">{{ $value->consultancycharge }} RS</p>
                    <div class="form-row">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="form-group">
                                <input name="area" type="text" class="form-control" placeholder="Enter your Area">
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="form-group">
                                <input name="landmark" type="text" class="form-control" placeholder="Enter Landamrk">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="form-group">
                                <input name="pincode" type="number" class="form-control" placeholder="Enter pincode">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            ...
                            <h5>Note: By placing order you are agree to pay price of product on delivery</h5>

                            <div class="text-center">
                                <button class="btn btn-main mt-3 " type="submit">Book home visit</button>
                            </div>
