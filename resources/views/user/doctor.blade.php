    ...
    <div class="row">
      <div class="col-lg-12 text-center">
          <ul class="list-inline mb-0">
           ...
           <h1 class="text-lg text-white mt-2">Appoint any doctor to visit at your home</h1>
      </div>
    </div>
  </div>
</section>
...
<section class="section blog bg-gray">
	...
	<article class="card border-0 rounded-0 mb-4">
		...
		<div class="mt-3 px-4 py-3 ">
			...
			<p class="mb-3">Type : {{ $value->specification }}</p>
			<div class="blog-post-meta text-capitalize mb-2">
				<p class=" mb-2"></i>Payment : {{ $value->consultancycharge }} RS </p>
				
			</div>
			

				<a href="/doccheckoutform/{{ $value->id }}"  class="btn btn-main mt-3">Take Appointment</a>
		</div>
	</article>
</div>
@endforeach
